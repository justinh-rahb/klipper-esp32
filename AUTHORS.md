...
This repository combines original ESP32-C3 work with code derived from earlier
Klipper and `klipper_esp32` projects. The file-level notices and Git history are
the authoritative record; this document makes the major contributions easier
to find.

## Justin Hayes

Justin Hayes <justinh@rahb.ca> is the primary author and maintainer of the
ESP32-C3 work in this repository, including:
